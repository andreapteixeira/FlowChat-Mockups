document.addEventListener("DOMContentLoaded", function(){
    ...
    var tempblock;
    var tempblock2;
    document.getElementById("blocklist").innerHTML = '<button id="kt_quick_panel_close_btn" class="kt-quick-panel__close">\n' +
        '                                                &times; <!-- Or use an icon if available -->\n' +
        '                                            </button><div class="blockelem create-flowy noselect">\n' +
        ...
        '\t</div>\n' +
        '</div>';
    // document.getElementById("blocklist").innerHTML = '<div id="fb_qualify_with_audience_1" class="auto-process-leads-action-item card mb-2 border blockelem create-flowy noselect" data-action="fb_qualify_with_audience" data-actionid="2c54036e18" data-socialplatform="facebook" data-counter="1">\n' +
    //     '                                                        <input type="hidden" name="blockelemtype" class="blockelemtype" value="1">\n' +
    //     '                                                        <div class="card-header action_sortable_handle" id="fb_qualify_with_audience_heading_1">\n' +
    //     '                                                            <div class="card-title py-2 collapsed" style="font-size:1rem; cursor: ns-resize">\n' +
    //     '                                                                <div class="bt-drag-action blockin">\n' +
    //     '                                                                    <i class="fas fa-grip-lines-vertical mr-3"></i>\n' +
    //     '                                                                </div>\n' +
    //     '\n' +
    //     '                                                                <i class="fab fa-facebook color-facebook"></i> Facebook: Qualify Profile with Audience\n' +
    ...
    function snapping(drag, first) {
        ...
        if (drag.querySelector(".blockelemtype").value == "1") {
            ...
            drag.innerHTML += '<div class="card-header action_sortable_handle" id="fb_qualify_with_audience_heading_1">\n' +
                '                                                            <div class="card-title py-2 collapsed" style="font-size:1rem; cursor: ns-resize">\n' +
                '                                                                <div class="bt-drag-action">\n' +
                '                                                                    <i class="fas fa-grip-lines-vertical mr-3"></i>\n' +
                '                                                                </div>\n' +
    ...
    var disabledClick = function(){
        ...
        if (this.getAttribute("id") == "triggers") {
            document.getElementById("blocklist").innerHTML = '<div class="blockelem create-flowy noselect">\n' +
            '\t<input type="hidden" name="blockelemtype" class="blockelemtype" value="1">\n' +
            '\t<div class="grabme">\n' +
    ...
    // Open panel
    document.getElementById('kt_quick_panel_toggler_btn').addEventListener('click', function() {
        document.getElementById('kt_quick_panel').classList.toggle('kt-quick-panel--open');
    });
    
    // Close panel
    document.getElementById('kt_quick_panel_close_btn').addEventListener('click', function() {
        document.getElementById('kt_quick_panel').classList.remove('kt-quick-panel--open');
    });
